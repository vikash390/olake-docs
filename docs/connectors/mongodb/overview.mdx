...
|-------------------|-----------| ---- | 
| <img src="/img/logo/local.png" width={20} height={20} /> Local Filesystem  | Yes       | [Link](../../writers/local) |
| <img src="/img/logo/s3.png" width={20} height={20} /> S3                | Yes       | [Link](../../writers/s3/overview) |
| <img src="/img/logo/iceberg.png" width={20} height={20} /> Iceberg           | WIP       | [Link](../../writers/iceberg) |
...
Read about about [local writer](../../writers/local) & S3 writer [here](../../writers/s3/overview)
