...
2. Data generation: Please refer to the repo we have published here - (https://github.com/datazip-inc/nyc-taxi-data-benchmark/tree/remote-postgres). 
3. We used AWS Glue as Iceberg catalog and AWS S3 as the storage layer for this benchmarks. 
