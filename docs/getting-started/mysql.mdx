...
:::info
OLake UI is live (beta)! You can now use the UI to configure your MySQL source, discover streams, and sync data. Check it out at [OLake UI](./olake-ui) regarding how to setup using Docker Compose and running it locally.
...
Refer to [MySQL Connector documentation](../connectors/mysql/overview) for more details.
:::
...
Refer here for more details on [Destination requirements](../writers/overview).
