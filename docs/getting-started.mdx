...
:::note
For setting up the project locally on your system and debugging configs to be made, follow this guide - [Setting up debugger in VS Code](./install/debug)
:::
...
## Debugging
Follow the debugging instructions in this guide - [Setting up debugger in VS Code](./install/debug)
