...
**Documentation & Quickstart:** [https://olake.io](https://olake.io/)
...
OLake is designed as a modular, high-performance system with distinct components that each excel at their core responsibilities. The following diagram (see [architecture cover image](https://olake.io)) provides a visual overview of how data flows through OLake:

![OLake Architecture](/img/blog/2025/01/olake-architecture-cover.webp)
...
3. **Parallel Processing:**  
   - Users can configure the number of parallel threads, balancing speed and the load on your MongoDB cluster.
...
- **GitHub Repository:** [https://github.com/datazip-inc/olake](https://github.com/datazip-inc/olake)
- **Documentation & Quickstart:** https://olake.io/docs

For any questions or feedback, please contact us at [hello@datazip.io](mailto:hello@olake.io) or schedule a quick demo [here](https://calendly.com/d/ckr6-g82-p9y/olake_discussion).
