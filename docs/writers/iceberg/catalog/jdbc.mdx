...
:::info
If you wish to test out the JDBC Catalog locally, you can use the [docker-compose](../../writers/iceberg/docker-compose) setup. The local test setup uses Minio as an S3-compatible storage and other all [supported catalog types](/docs/writers/iceberg/docker-compose#local-catalog--test-setup). 
