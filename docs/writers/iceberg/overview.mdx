...
1. Create a config file and lets name it `source.json`,
...
2. `destination.json` - holds the iceberg writer configurations like iceberg table name, iceberg database name, catalog information, etc.
:::
