...
This component allows you to efficiently write your database data into Amazon S3 in Parquet format. For more background details, please refer to the [README](https://github.com/datazip-inc/olake/blob/master/README.md). Before proceeding, make sure you have completed the [getting started](../category/getting-started) instructions.
