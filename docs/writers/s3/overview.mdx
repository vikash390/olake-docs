...
This will create a S3 destination in OLake, now you can use this destination in your [Jobs Pipeline](../../jobs/overview) to sync data from any [Database](../../connectors/overview) to [AWS S3](../../writers/s3/overview).
