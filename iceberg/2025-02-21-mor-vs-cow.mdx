...
Our team at [OLake](olake.io) also recently conducted a similar performance test comparing **PostgreSQL** operations with Iceberg reflection times on a substantial dataset of nearly **67 million rows**.
