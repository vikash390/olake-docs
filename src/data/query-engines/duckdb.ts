...
export const duckdb: QueryEngine = {
  ...
  category: 'analytics',
  website: 'https://duckdb.io/',
  documentation: 'https://duckbd.io/docs/current/connector/iceberg.html',
  features: {
    catalogs: {
      support: 'partial',
  ...
  quickStart: `-- Configure Iceberg connector in duckdb
