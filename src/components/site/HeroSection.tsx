...
const HeroSection: React.FC<HeroSectionProps> = ({
    ...
    return (
        <div className="flex flex-col lg:flex-row items-start justify-between w-full max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-16 lg:py-20">
            {/* Left Column - contains 2 rows */}
            <div className="w-full lg:w-3/5 flex flex-col mb-8 lg:mb-0">
                ...
                <div className="mb-8">
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold">
                        ...
                        <span className="text-blue-600">Data Lakehouses</span>
                    </h2>
