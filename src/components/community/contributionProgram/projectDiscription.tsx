  ...
  return (
    <SectionLayout className='items-center justify-center  md:mx-80'>
      <div className='flex flex-col'>
        ...
        <p>
          The Airbyte Contributor Program is a collaboration with the community with the goal to
        ...
        <p>
          ...
          receive support from our team. In addition to becoming an official Airbyte project
